...
<img src="/docs/images/search_billing.png" width="350" height="200">
...
<img src="/docs/images/aws_cost_management.png" width="350" height="200">

2. Click on `Cost Explorer` on the left panel

<img src="/docs/images/cost_explorer.png" width="350" height="200">

3. Change the end date to today's date. By default it will show you billing to the end of last month.

<img src="/docs/images/change_end_date.png" width="350" height="200">

4. Filter for different parameters on the right. Here we can filter by Service to select only costs related to EC2.

<img src="/docs/images/Ec2_filter_service.png" width="350" height="200">

Now we see only costs related to EC2.

<img src="/docs/images/ec2-filtered.png" width="350" height="200">

5. Filter for the tags we added in Part 1 to benchmark a specific analysis.

<img src="/docs/images/filter_tag.png" width="350" height="200">
...
<img src="/docs/images/blast_costs.png" width="350" height="200">
