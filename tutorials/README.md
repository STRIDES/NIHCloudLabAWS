...
- Most medical imaging analyses are done in notebooks, so we would recommend accessing this [Jupyter Notebook](/tutorials/notebooks/BrainTumorSegmentation) and importing or cloning it into Sagemaker. The tutorial walks through brain image segmentation.
